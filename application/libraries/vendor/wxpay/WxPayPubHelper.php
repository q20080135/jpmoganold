...
*/
	...
	define('WXPAY_DIR', dirname(__FILE__));
/**
 * 所有接口的基类
 */
class Common_util_pub
{
	...
	function postXmlSSLCurl($xml,$url,$second=30)
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT, WXPAY_DIR.WxPayConfig::SSLCERT_PATH);
		//默认格式为PEM，可以注释
		curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
		curl_setopt($ch,CURLOPT_SSLKEY, WXPAY_DIR.WxPayConfig::SSLKEY_PATH);
		//post提交方式
		curl_setopt($ch,CURLOPT_POST, true);
		curl_setopt($ch,CURLOPT_POSTFIELDS,$xml);
		$data = curl_exec($ch);
...
class JsApi_pub extends Common_util_pub
{
	...
	public function getAppParameters()
	{
		$timeStamp = time();
		$jsApiObj["appid"] = WxPayConfig::APPID;
		$jsApiObj['partnerid'] = WxPayConfig::MCHID;
		$jsApiObj["timestamp"] = "{$timeStamp}";
		//$jsApiObj["noncestr"] = $this->createNoncestr();
