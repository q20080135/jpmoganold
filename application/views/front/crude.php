...
?>
  ...
  <div class="new_content">
  	<div class="crude_display">
  	  <div class="crude_display_center">
  		<p>世界上最重要的自然资源</p>
  		<p>点差低，交易成本低</p>
  		<p>THE MOST IMPORTANT NATURAL RESOURCE IN THE WORLD</p>
  	  </div>
  	</div>
  	<div class="crude_text">
  	  <div class="crude_text_top">
  	  	...
  	  	<p style="color:#444;font-size:28px;font-weight:bold">CRUDE OIL</p>
  	  </div>
      <i></i>
      <div class="crude_text_title">
        原油
      </div>
      <div class="crude_text_bot">
        <h1>CRUDE OIL</h1>
        <p>原油是世界上最重要的自然资源之一，也是交易最频繁的商品之一。在JPMogan平台可以进行现货原油交易，即以特定品质的原油作为交易标的物的现货合约，是一种CFD交易，不涉及商品本身，仅以保证金作为风险保障，实行的是T+0交易制度，可以买涨或买跌，无涨跌板限制，风险程度小，交收方式灵活，适合套现。对于投资者来说，投资性比其他类型的交易更强，收益也高。目前JPMogan平台为客户提供的是市场上广为交易的美国原油（西德克萨斯中质油）和布伦特原油，投资者仅需一个账户就可轻松进行交易。</p>
      </div>  
  	</div>

    <div class="crude_view">
      <div class="crude_view_top">
        <p><i style="display:inline-block;width:50px;border-bottom:1px solid #b09373;position:relative;top:-5px;left:-30px"></i><b style="position:relative;top:-3px;left:-20px;display:inline-block;width:6px;height:6px;border-radius:3px;background-color:#bfbfbf"></b>
          <span>原油合约细则</span>
          <b style="position:relative;top:-3px;left:20px;display:inline-block;width:6px;height:6px;border-radius:3px;background-color:#bfbfbf"></b><i style="position:relative;top:-5px;left:30px;display:inline-block;width:50px;border-bottom:1px solid #b09373"></i>
        </p>
        <p style="color:#444;font-size:28px;font-weight:bold">CRUDE OIL  CONTRACT TERMS</p>
      </div>
      <i></i>
      <br><br>     
    </div>
    ...
    <div class="crude_table">
      <table>
        ...
        <tbody>
         <tr>
           ...
           <td>1,000</td>
           <td>1%</td>
           <td>周一至周六:06:00 -04:55</td>
           <td>交易日:05:00-06:00</td> 
         </tr>
         <tr>
           <td>UKO/USD</td>
           <td>0.1</td>
      ...
      <p>注：差价合约交易是一种具有高风险的杠杆交易，并不适合所有的投资者，它可能导致您的亏损超出您的初始本金。您必须在充分了解其风险后，在自己可承受的资金范围内进行投资交易。</p>   
    </div>
  </div>
