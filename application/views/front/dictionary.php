...
?>
  ...
  <div class="new_content">
    <div class="dictionary_display">
      ...
      <p>JPMogan</p>
      <p>THE DICTIONARY</p>
      <p><span style="color:#fcb600">外汇</span>词典</p>
      </div>
    </div>
      ...
      <div class="dictionary_main_top">
        ...
        <div class="dictionary_main_bot">      
          <div class="company_overview_content"> 
            ...
            <h3>1、点Pip<i></i></h3> 
            <p>汇率变动的最小单位就是点。如果欧元/美元的汇率由1.2250上升到1.2251,则其变动恰好是1个点。外汇报价的最后一位就是点数的个位，倒数第二位就是点数的十位，依此类推。</p> 
            ...
            <p>点值就是在进行外汇交易的时候，买入价和卖出价之间一个点的价值。详情请参考外汇计算。</p> 
            ...
            <p>外汇中的合约数也叫合约单位，就是交易量本身，是买/卖货币的量。比如：外汇中，10万的合约单位为1标准手，也叫100K（K=kilogram），也就是指每笔单的最小交易份额是100000个基准货币。</p> 
            <h3>7、STP<i></i></h3> 
            ...
            2) 点差类型 <br /> 固定点差的STP外汇平台：不以多个流动性提供商中的最低买入买出价为依据调整点差大小，点差始终是固定。如果该STP经纪商只有一个流动性提供商，这个流动性提供商的角色就是交易者唯一的反方，这种情况下买入/卖出价全由这个流动性提供商决定。<br /> 浮动点差的STP外汇平台：流动性提供商提供最好的买入/卖出价，STP经纪商会从一个流动性提供商中选了一个最好的买入价， 从另一个流通者那选择一个最的买出价，这样就可以为客户提供最低的买卖点差。<br> 
            ...
            <p>买入价是外汇市场上愿意买人某个特定货币对的价格。交易人可以以这个价格卖出基本货币，它在报价单的左边。比如，美元／瑞士法郎报价是1．4527／32，其买入价是1．4527；也就是说，你可以把1美元卖1．4527瑞士法郎。<br /> 卖出价是外汇市场上愿意卖出某个特定货币对的价格。交易人可以以这个价格买入基本货币，它在报价单的右边。比如，美元／瑞士法郎报价是1．4527／32，其卖出价是1．4532；就是说，你可以以1．4532瑞士法郎买人1美元。外汇卖出价又叫卖出汇率。</p> 
            <h3>12、价差Spread<i></i></h3> 
            <p>价差是买入价和卖出价间的差额。</p> 
            <h3>13、报价方式Quotation<i></i></h3> 
            <p>外汇市场中的汇率用以下格式来表示：<br /> 基本货币／报价货币 买入价／卖出价<br /> 如： 欧元/美元1．2604／07， 英镑／美元1．5089／94 ，瑞士法郎／日元84．40／45<br /> 正常情况下，只显示最后的两个数字。如果卖出价超过买入价100点，那么斜线的右边就会有三个数字(如欧元／捷克克郎32．5420／780)。只有当报价货币非常疲软时才会出现这种情况。</p> 
            ...
            <p>外汇交易中，每笔交易均涉及两种货币，当中包含两个不同的利率，而利息的支付或收取都是以两者的利息差和持仓方向而定。利率是按照两国货币利率差额作为计算依据，当投资者卖出息率较高/买入息率较低的货币，便需要支付隔夜利息；当投资者买入息率较高/卖出息率较低的货币，则可以赚取隔夜利息。利息根据银行惯例按照T+2延迟清算，即两个银行工作日后开始计算。参见外汇计算<br /> 隔夜利息=年利率差/360天*1标手合约单位*手数*汇率价格（多/空）*计息天数</p> 
        ...
        <div class="dictionary_main_bot">  
            ...
            <div class="company_overview_content">
                   <div class="company_overview_content_title">
                    ...
                    <p>交易预期未来外汇市场的价格将下跌， 即按目前市场价格卖出一定数量的货币或期权合约，等价格下跌后再补进以了结。</p>
                    <h3>3、买入/多头/做多Long<i></i></h3>
                    <p>交易者预期未来外汇市场价格将上涨， 以目前的价格买进一定数量的货币，待一段时间汇率上涨后，以较高价格对冲所 持合约部位，从而赚取利润。这种方式属于先买后卖的交易方式。</p>
                    ...
                    <p>作空头方向于外汇市场卖完后，汇率不跌反涨，逼得空头 不得不强补买回。</p>
      ...
      <div class="dictionary_main_top">
        ...
        <div class="dictionary_main_bot">
          ...
          <div class="company_overview_content"> 
            ...
            <p>指在国际外汇市场上，一个国家的货币直接跟美元进行兑换的就是直盘，简单的这样理解：凡是和美元直接联系的都是直盘，例：EUR/USD（欧元/美元）， USD/CAD（美元/加元）等。</p> 
            ...
            <p>货币外汇汇率（FXRate， Foreign Exchange Rate）是以另一国货币来表示本国货币的价格，如USD/CHF汇率为1.0022，那么意味着1美元等于1.0022瑞郎。</p> 
            ...
            <p>是指制定出基本汇率后，本币对其他外国货币的汇率就可以通过基本汇率加以套算，这样得出的汇率就是交叉汇率，又叫做套算汇率（也叫交叉盘）。外汇交易中常常会涉及两种非美元货币的交易，而国际金融市场的报价多数是美元对另一种货币的报价，此时，需要进行汇率套算。</p> 
            <h3>9、同业买卖汇率Inter-Bank Rate<i></i></h3> 
            <p>又称银行间汇率，是指银行间进行外汇买卖时的汇率。它高于买入汇率，低于卖出汇率，一般为介于两者之间的中间价。外汇银行对银行间汇率另加一定的差额后决定对顾客汇率。银行汇率是批发价，对顾客汇率是零售价。</p> 
            ...
            <p>展期交割是将一个交易的原有交割日向后延展到另一个日期的 过程。这个过程的成本由两种货币的利率差价而定。<br /> 用保证金进行外汇交易可以提高你的购买力。如果你的保证金账 户中有2，000美元，允许的杠杆是100：1，你就可以最高买人价格 2，000，000美元的外汇，因为你只须交购买价格的百分之一作为抵 押。换句话说，你有2，000，000美元的购买力。</p> 
            <h3>18、交易对手Counterparty<i></i></h3> 
            <p>在外汇市场交易中，想要买一件产品，必须同时有另一个人卖这个产品，交易才能达成，这种供求关系形成了流动性，而订单的接收方则成为交易对手。也就是说，当你赚钱时，交易对手亏钱；当你亏钱时，交易对手赢钱。当经纪商成为客户的交易对手时，就是B-book模式；当经纪商的上一级流动性提供方：中型银行、做市商银行等成为客户的交易对手时，就是A-Book。</p> 
